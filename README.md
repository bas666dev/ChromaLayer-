...
- `data-animation="pulse"`, `data-pulse-speed-ms`, `data-hue-shift-deg`, `data-brightness-amp` on the wrapper
- `data-phase`, `data-phase-label`, `data-phase-desc` on the wrapper
- `data-hue`, `data-huename`, optional `data-phase`, and matching `data-animation` attributes on each span
